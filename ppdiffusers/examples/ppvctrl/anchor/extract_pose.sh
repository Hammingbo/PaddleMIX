python anchor/extract_pose.py  \
       ...
       --video_file=./examples/pose/case6/pixel_values.mp4  \
       --device=gpu \
       --output_dir=./examples/pose/case6/guide_values.mp4 \
       --reference_image_path=./examples/pose/case6/reference_image.jpg \